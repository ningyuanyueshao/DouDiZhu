    ...
    static boolean Add_usr(String usr_name,String usr_pwd)//添加新注册的用户，如果添加成功，则返回true，添加失败返回false
    {
        ...
        try {
            ...
            stmt.executeUpdate("create table if not exists `user_pwd_table`(" +
                    ...
                    "`user_pwd` varchar(20)," +
                    "`user_score` int)character set utf8mb4 collate utf8mb4_general_ci");
            ...
            {
                String sqlStr = String.format("insert into user_pwd_table(user_name, user_pwd, user_score) values ('%s','%s',0)",usr_name,usr_pwd);
